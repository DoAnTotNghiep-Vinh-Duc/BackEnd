...
export class ProductController{
    ...
    static async filterProduct (req: Request, res: Response): Promise<any> {
        try {
            const {optionSort,listType, keySearch, optionPrice, optionSizes, optionColors, optionRates} = req.body;
            const data: any = await ProductService.filterProduct(optionSort,listType, keySearch, optionPrice, optionSizes, optionColors, optionRates);
            return res.status(data.status).json(data);
