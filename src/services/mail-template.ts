            ...
            template: {
                ...
                static async getMailTemplateForgotPassword(data: any, lang: string, callback: any) {
                  ...
                  <div style="width: 100%; height: 20%">
                      ...
                      <div style="width: 20%; height: 80%; margin: 0 auto">
                          <img style="width: 50px; height: 50px" src="https://img.icons8.com/clouds/100/000000/handshake.png"
                              alt="" />
                      </div>
                  </div>
                  <div style="width: 100%; height: 55%">
              ...
              <div style="
                  ...
                  <div style="margin-bottom: 5px">
                      Hotline:
                      <a href="tel:0359806602" style="text-decoration: none; color: #0d0e43" target="_blank">(+84) 359 806 602</a>
                  </div>
                  <div style="margin-bottom: 5px">
                      Địa chỉ: 12 Nguyễn Văn Bảo, phường 5, quận Gò Vấp, TP.HCM
                  </div>
                  ...
                  <div>
                      Facebook:
                      <a href="https://www.facebook.com/profile.php?id=100008079398913" style="text-decoration: none"
                          target="_blank">https://www.facebook.com/profile.php?id=100008079398913</a>
                  </div>
                  <div>
                      Instagram:
                      <a href="https://www.facebook.com/profile.php?id=100008079398913"
                          style="text-decoration: none">https://www.facebook.com/profile.php?id=100008079398913</a>
                  </div>
              </div>
              </div>`
              }
